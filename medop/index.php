...
<head><title>Medop: Smart medical service</title>
  <meta charset="utf-8">
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid ">
    <div class="navbar-header">
      <a class="navbar-brand text-dark" href="#myPage"><strong>medop</strong></a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu"> 
       <li> <a href="location map/mumbai.html">Mumbai</a></li>
      <li>  <a href='location map/pune.html'>Pune</a></li>
       <li> <a href="location map/madhyapradesh.html">Madhya Pradesh</a></li>
        </ul>
        </li>
   ...
   <li> <a href="#contact" onclick="toggleFunction()">Contact Us</a></li>
            	...
            	<li><a href="Admin/notification.php">Notification<?php ?></a></li>
...
<footer class="text-center">
  ...
  <p>Copyright<a href="http://labaidgroup.com/specialized/doctor" data-toggle="tooltip" title="medop">@Medop</a></p> 
</footer>
<script>
